...
def plot_ref_spectrum(
    crystal="Cu", ax="new", height=100, color=None, label=True, lam=None, E=1.7e4
):
    if ax == "new":
        fig, ax = plt.subplots()
    if color is None:
